    ...
    <footer className="bg-accent text-accent-foreground">
      <div className="container-x py-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Follow us */}
          <div>
            <h3 className="mb-2 text-sm font-bold">{t("contact.followUs")}:</h3>
        ...
        {/* Mission line */}
        <p className="mt-6 border-t border-current/20 pt-4 text-xs opacity-90">
      ...
      <div className="border-t border-current/20">
        <div className="container-x flex flex-col gap-2 py-3 text-[11px] opacity-80 md:flex-row md:items-center md:justify-between">
